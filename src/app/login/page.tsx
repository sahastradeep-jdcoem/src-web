          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-6">
            ...
            <div className="space-y-4 pt-2">
              ...
              >
                ...
                <span>{isSubmitting ? "Signing In with Google..." : "Continue with Google (College or Personal)"}</span>
              </button>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-1.5">
                <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-[#17458F]">
                  ...
                  <span>Institutional & Inter-Collegiate Authentication</span>
                </div>
                <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
                  Sign in with any Google account. Onboard seamlessly as a <strong>JDCOEM Student</strong> (with BT ID), <strong>Faculty Member</strong> (no BT ID required), or <strong>Visiting College Delegate</strong>.
                </p>
              </div>
            </div>
