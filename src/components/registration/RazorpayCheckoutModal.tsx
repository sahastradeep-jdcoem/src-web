                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-slate-400 font-medium">Wallet &amp; UPI direct</span>
                    </div>
                  </div>
      ...
      <div className="hidden sm:flex flex-row w-full bg-white font-sans text-left min-h-[580px] max-h-[90vh] relative overflow-hidden select-none">
        ...
        <div className="w-80 bg-gradient-to-b from-[#2B64E2] via-[#245BD6] to-[#1B4EC2] text-white p-6 flex flex-col justify-between relative shrink-0 shadow-lg">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-white/20 border border-white/30 backdrop-blur-md flex items-center justify-center font-black text-xl text-white shadow-inner">
                S
              </div>
              <div className="min-w-0">
                <div className="font-heading font-black text-base text-white uppercase tracking-wider truncate">
                  SRC JDCOEM
                </div>
            ...
            {/* Price Summary Card */}
            <div className="bg-white rounded-2xl p-4 text-slate-800 shadow-md space-y-1">
            ...
            <div className="bg-white/15 backdrop-blur-md rounded-xl p-3 border border-white/20 flex items-center justify-between text-xs font-medium text-white/90 shadow-xs">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="w-full flex items-end justify-center opacity-85 pointer-events-none">
              <svg width="220" height="110" viewBox="0 0 220 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g transform="translate(130, 45) rotate(-15) skewX(10)">
        ...
        {/* RIGHT MAIN PANEL: Split Method Navigation + Detail Workspace */}
        <div className="flex-1 flex flex-col min-w-0 bg-white">
          
          {/* Top Bar: Title & Controls */}
          <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between shrink-0">
            <h3 className="font-heading font-black text-base text-slate-800 tracking-wide">
              Payment Options
            </h3>
            <div className="flex items-center gap-2">
              <button
          ...
          {/* Body Split: Left Methods Sidebar + Right Active Method Area */}
          <div className="flex-1 flex flex-row min-h-0 overflow-hidden">
            
            {/* Left Method Selection List (w-60) */}
            <div className="w-60 border-r border-slate-100 p-3 space-y-1 shrink-0 bg-slate-50/50 overflow-y-auto">
              {/* UPI / QR Tab (Default & Primary) */}
              <button
                type="button"
                onClick={() => setActiveTab("upi")}
                className={`w-full text-left p-3 rounded-xl transition-all flex items-center justify-between cursor-pointer ${
                  activeTab === "upi"
                    ? "bg-white border-l-4 border-[#2B64E2] text-slate-900 shadow-xs font-bold"
                    : "text-slate-600 hover:bg-white hover:text-slate-900 font-medium"
                }`}
              >
                <div className="flex items-center gap-2.5">
                  <div className={`p-1.5 rounded-lg ${activeTab === "upi" ? "bg-blue-50 text-[#2B64E2]" : "bg-slate-100 text-slate-500"}`}>
                ...
                {activeTab === "upi" && <ChevronRight className="w-4 h-4 text-[#2B64E2]" />}
              </button>
              ...
              >
                <div className="flex items-center gap-2.5">
                  <div className={`p-1.5 rounded-lg ${activeTab === "cards" ? "bg-blue-50 text-[#2B64E2]" : "bg-slate-100 text-slate-500"}`}>
                    <CreditCard className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-xs block">Cards</span>
                    <span className="text-[9px] text-slate-400 font-normal">Visa, Master, RuPay</span>
                  </div>
                </div>
                {activeTab === "cards" && <ChevronRight className="w-4 h-4 text-[#2B64E2]" />}
              </button>
              ...
              >
                <div className="flex items-center gap-2.5">
                  <div className={`p-1.5 rounded-lg ${activeTab === "netbanking" ? "bg-blue-50 text-[#2B64E2]" : "bg-slate-100 text-slate-500"}`}>
                    <Building2 className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-xs block">Netbanking</span>
                    <span className="text-[9px] text-slate-400 font-normal">All Indian Banks</span>
                  </div>
                </div>
                {activeTab === "netbanking" && <ChevronRight className="w-4 h-4 text-[#2B64E2]" />}
              </button>
              ...
              >
                <div className="flex items-center gap-2.5">
                  <div className={`p-1.5 rounded-lg ${activeTab === "wallet" ? "bg-blue-50 text-[#2B64E2]" : "bg-slate-100 text-slate-500"}`}>
                    <Wallet className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-xs block">Wallet</span>
                    <span className="text-[9px] text-slate-400 font-normal">PhonePe &amp; Others</span>
                  </div>
                </div>
                {activeTab === "wallet" && <ChevronRight className="w-4 h-4 text-[#2B64E2]" />}
              </button>
            </div>
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-5">
              {activeTab === "upi" ? (
                <>
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="text-sm font-heading font-black text-slate-800">
                        Scan QR Code or Select UPI App
                      </h4>
                      <p className="text-[11px] text-slate-500 font-medium mt-0.5">
                        Pass will be activated instantly upon payment confirmation
                      </p>
                    </div>
                  ...
                  {/* 2-Column Desktop Grid: Left QR Card, Right Quick Apps */}
                  <div className="grid grid-cols-12 gap-5 items-start">
                    {/* Left: Scannable QR Code */}
                    <div className="col-span-5 p-4 rounded-2xl bg-white border border-slate-200 shadow-xs text-center flex flex-col items-center justify-center space-y-2">
                      <div className="w-full flex items-center justify-between text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">
                        <span>Scan &amp; Pay</span>
                        <span className="text-blue-600 font-semibold lowercase">any app</span>
                      </div>
                      ...
                      <p className="text-[11px] text-slate-500 font-medium leading-tight">
                        Point phone camera to scan &amp; pay
                      </p>
                    </div>

                    {/* Right: 1-Tap UPI Apps */}
                    <div className="col-span-7 space-y-2">
                      ...
                      <a
                        href={paytmCheckoutData.gpayLink || paytmCheckoutData.upiLink}
                        className="group flex items-center justify-between p-3 rounded-xl border border-slate-200 bg-white hover:border-[#4285F4] hover:shadow-xs transition-all no-underline"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200/60 flex items-center justify-center font-bold text-xs shrink-0">
                            <span className="text-[#4285F4]">G</span>
                            <span className="text-[#EA4335]">P</span>
                            <span className="text-[#FBBC05]">a</span>
                            <span className="text-[#34A853]">y</span>
                          ...
                          <div>
                            <span className="text-xs font-bold text-slate-800 group-hover:text-[#4285F4] transition-colors block">
                              Google Pay
                            </span>
                            <span className="text-[10px] text-slate-400">Direct UPI settlement</span>
                          </div>
                        </div>
                        <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#4285F4] transition-colors" />
                      </a>
                      ...
                      <a
                        href={paytmCheckoutData.phonepeLink || paytmCheckoutData.upiLink}
                        className="group flex items-center justify-between p-3 rounded-xl border border-slate-200 bg-white hover:border-[#5f259f] hover:shadow-xs transition-all no-underline"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-lg bg-[#5f259f]/10 border border-[#5f259f]/20 flex items-center justify-center font-black text-xs text-[#5f259f] shrink-0">
                            पे
                          </div>
                          <div>
                            <span className="text-xs font-bold text-slate-800 group-hover:text-[#5f259f] transition-colors block">
                              PhonePe
                            </span>
                            <span className="text-[10px] text-slate-400">Instant UPI pass issue</span>
                          </div>
                        </div>
                        <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#5f259f] transition-colors" />
                      </a>
                      ...
                      <a
                        href={paytmCheckoutData.paytmLink || paytmCheckoutData.upiLink}
                        className="group flex items-center justify-between p-3 rounded-xl border border-slate-200 bg-white hover:border-[#002970] hover:shadow-xs transition-all no-underline"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-lg bg-[#00b9f5]/10 border border-[#00b9f5]/25 flex items-center justify-center font-black text-xs text-[#002970] shrink-0">
                            PTM
                          </div>
                          <div>
                            <span className="text-xs font-bold text-slate-800 group-hover:text-[#002970] transition-colors block">
                              Paytm UPI
                            </span>
                            <span className="text-[10px] text-slate-400">Instant UPI transfer</span>
                          </div>
                        </div>
                        <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#002970] transition-colors" />
                      </a>
                      ...
                      <a
                        href={paytmCheckoutData.upiLink}
                        className="group flex items-center justify-between p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-white hover:border-slate-300 transition-all no-underline"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-lg bg-slate-200/80 flex items-center justify-center text-slate-600 shrink-0">
                            <CreditCard className="w-4 h-4" />
                          </div>
                          <div>
                            <span className="text-xs font-bold text-slate-700 block">Other UPI Apps</span>
                            <span className="text-[10px] text-slate-400">BHIM, CRED, WhatsApp, Banks</span>
                          </div>
                        </div>
                        <ChevronRight className="w-4 h-4 text-slate-400" />
                      </a>
                  ...
                  {/* Auto-Approval Live Radar Banner */}
                  <div className="p-3.5 rounded-2xl bg-emerald-50/80 border border-emerald-200 text-left space-y-2 relative overflow-hidden shadow-xs">
                    <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-emerald-300 via-emerald-500 to-emerald-300 animate-pulse" />
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span className="relative flex h-2.5 w-2.5">
                    ...
                    <p className="text-xs text-emerald-900 leading-relaxed font-medium">
                      Complete payment via Google Pay, PhonePe, or QR Code. This portal will <strong>automatically generate and verify your official pass</strong> in real time.
                    </p>
                  </div>
                  ...
                  <div className="pt-1 text-center">
                    {!showManualUtr ? (
                      <button
                        type="button"
                        onClick={() => setShowManualUtr(true)}
                        className="text-[11px] text-slate-400 hover:text-slate-700 font-medium underline underline-offset-4 py-1 transition-colors cursor-pointer"
                      >
                        Having trouble? Paid but pass didn&apos;t activate? Enter UTR manually &rarr;
                      </button>
                    ) : (
                      <div className="p-4 rounded-2xl bg-white border border-slate-200 text-left space-y-3 animate-in fade-in duration-150 shadow-sm">
                        <div className="flex items-center justify-between">
                          <label className="text-xs font-bold text-slate-800 uppercase tracking-wider">
                            12-Digit UPI Reference (UTR)
                          </label>
                        ...
                        <input
                          ...
                          className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-sm font-mono text-slate-900 tracking-wider focus:outline-none focus:ring-2 focus:ring-[#2B64E2]/30"
                        />
                        ...
                        <Button
                          ...
                          variant="primary"
                          size="md"
                          className="w-full justify-center gap-2 cursor-pointer bg-[#2B64E2] hover:bg-[#1E52C6]"
                        >
                          <Check className="w-4 h-4" />
                          <span>Verify UTR &amp; Issue Pass</span>
                        </Button>
                ...
                /* Informational State for Cards / Netbanking / Wallet */
                <div className="p-8 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-4 my-auto">
                  <div className="w-12 h-12 rounded-2xl bg-blue-50 text-[#2B64E2] flex items-center justify-center mx-auto">
                    <Sparkles className="w-6 h-6" />
                  </div>
                  <div className="space-y-1 max-w-sm mx-auto">
                    <h4 className="text-sm font-heading font-black text-slate-900 uppercase tracking-wide">
                      Instant Zero-Fee Settlement
                    </h4>
                    <p className="text-xs text-slate-500 leading-relaxed font-medium">
                      To ensure zero convenience charges and instant automated ticket pass activation for students, official payments are routed via <strong>UPI &amp; Scannable QR</strong>.
                    </p>
                  </div>
                  <Button
                    onClick={() => setActiveTab("upi")}
                    variant="primary"
                    className="bg-[#2B64E2] hover:bg-[#1E52C6]"
                  >
                    Pay via UPI / QR Code &rarr;
                  </Button>
                </div>
              )}
            </div>
