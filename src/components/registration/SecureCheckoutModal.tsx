      ...
      <div className="hidden sm:flex flex-row w-full bg-white font-sans text-left relative overflow-hidden select-none">
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white">
          ...
          <div className="flex-1 flex flex-row min-h-0 overflow-hidden">
            ...
            {/* Left Method Selection List (w-48) */}
            <div className="w-48 border-r border-slate-100 p-2.5 space-y-1 shrink-0 bg-slate-50/50 overflow-y-auto">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-[9px] text-slate-400 font-normal">Scan &amp; Pay</span>
                  </div>
                </div>
                {activeTab === "upi" && <ChevronRight className="w-3.5 h-3.5 text-[#2B64E2]" />}
              </button>
              ...
              >
                ...
                {activeTab === "cards" && <ChevronRight className="w-3.5 h-3.5 text-[#2B64E2]" />}
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-[9px] text-slate-400 font-normal">Indian Banks</span>
                  </div>
                </div>
                {activeTab === "netbanking" && <ChevronRight className="w-3.5 h-3.5 text-[#2B64E2]" />}
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-[9px] text-slate-400 font-normal">Paytm &amp; More</span>
                  </div>
                </div>
                {activeTab === "wallet" && <ChevronRight className="w-3.5 h-3.5 text-[#2B64E2]" />}
              </button>
            </div>
            ...
            <div className="flex-1 p-5 overflow-y-auto space-y-3.5">
              {activeTab === "upi" ? (
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 font-medium mt-0.5">
                        Open Google Pay, PhonePe, Paytm, or any UPI app on your phone to scan
                      </p>
                    </div>
                ...
                <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-3 my-auto">
                  <div className="w-10 h-10 rounded-2xl bg-blue-50 text-[#2B64E2] flex items-center justify-center mx-auto">
                  ...
                  <div className="space-y-1 max-w-sm mx-auto">
                    ...
                    <p className="text-[11px] text-slate-500 leading-relaxed font-medium">
                      To ensure zero convenience charges and instant ticket activation, official payments are routed via <strong>UPI &amp; Scannable QR</strong>.
                    </p>
                  </div>
                  <Button
                    onClick={() => setActiveTab("upi")}
