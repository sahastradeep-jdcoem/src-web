...
interface PillarsOfStrengthSectionProps {
  className?: string;
  boxed?: boolean; // when false, render unboxed/open layout (for pages that want full-bleed placement)
}

export function PillarsOfStrengthSection({ className = "", boxed = true }: PillarsOfStrengthSectionProps) {
