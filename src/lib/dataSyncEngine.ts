...
/**
 * Check if a local write was made within the last `withinMs` milliseconds (defaults to 15s).
 */
export function isLocalWriteRecent(docId: string, withinMs = 15000): boolean {
